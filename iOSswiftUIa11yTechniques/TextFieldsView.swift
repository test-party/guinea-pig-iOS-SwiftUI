        ...
        ScrollView {
            VStack {
                ...
                TextField("", text: $fname, axis: .vertical)
                    ...
                    .border(.secondary)
                    .accessibilityLabel("First Name for form-pass-1")
                ...
                TextField("", text: $lname, axis: .vertical)
                    .textFieldStyle(.roundedBorder)
                    .border(.secondary)
                    .accessibilityLabel("Last Name for form-pass-1")
                    .autocorrectionDisabled(true)
                ...
                TextField("", text: $username, axis: .vertical)
                    .textFieldStyle(.roundedBorder)
                    .border(.secondary)
                    .accessibilityLabel("Username for form-pass-1")
                ...
                SecureField("", text: $password)
                    .textFieldStyle(.roundedBorder)
                    .border(.secondary)
                    .accessibilityLabel("Password for form-pass-1")
                ...
                TextField("", text: $email, axis: .vertical)
                    .textFieldStyle(.roundedBorder)
                    .border(.secondary)
                    .accessibilityLabel("Email for form-pass-1")
                ...
                TextField("", text: $address, axis: .vertical)
                    ...
                    .textFieldStyle(.roundedBorder)
                    .border(.secondary)
                    .accessibilityLabel("Street Address for form-pass-1")
                ...
                TextField("", text: $address2, axis: .vertical)
                    ...
                    .textFieldStyle(.roundedBorder)
                    .border(.secondary)
                    .accessibilityLabel("Street Address Line 2 for form-pass-1")
                ...
                TextField("", text: $state, axis: .vertical)
                    .textFieldStyle(.roundedBorder)
                    .border(.secondary)
                    .accessibilityLabel("State for form-pass-1")
                ...
                TextField("", text: $phone, axis: .vertical)
                    .textFieldStyle(.roundedBorder)
                    .border(.secondary)
                    .accessibilityLabel("Phone Number for form-pass-1")
                ...
                TextField("", text: $website, axis: .vertical)
                    .textFieldStyle(.roundedBorder)
                    .border(.secondary)
                    .accessibilityLabel("Website for form-pass-1")
                    .keyboardType(.URL)
                ...
                TextField("", text: $birthday, axis: .vertical)
                    .textFieldStyle(.roundedBorder)
                    .border(.secondary)
                    .accessibilityLabel("Birth Date for form-pass-1")
                    .autocorrectionDisabled(true)
                ...
                TextField("", text: $bday, axis: .vertical)
                    .textFieldStyle(.roundedBorder)
                    .border(.secondary)
                    .accessibilityLabel("Birth Date Day for form-pass-1")
                    .autocorrectionDisabled(true)
                ...
                TextField("", text: $bmonth, axis: .vertical)
                    .textFieldStyle(.roundedBorder)
                    .border(.secondary)
                    .accessibilityLabel("Birth Date Month for form-pass-1")
                    .autocorrectionDisabled(true)
                ...
                TextField("", text: $byear, axis: .vertical)
                    .textFieldStyle(.roundedBorder)
                    .border(.secondary)
                    .accessibilityLabel("Birth Date Year for form-pass-1")
                    .autocorrectionDisabled(true)
